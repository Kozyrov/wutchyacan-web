...
import { addProject, selectAllProjectOptions } from '../../entities/project/projectSlice';
  ...
  const renderNewProjectEntryModal = () => {
    return (
      <ModalOverlay toggleOff={cancelEntry}>
        <ProjectEntry save={handleProjectSave} cancel={cancelEntry} incomingProject={freshProject}/>
      </ModalOverlay>
    );
  }
